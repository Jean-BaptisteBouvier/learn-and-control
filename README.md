...
1. We learn the dynamics of the pendulum: given a state *s(t)* and an action *a(t)*, the neural net predicts the next state difference *s(t+dt)-s(t)*.
    ![](Dynamics_learning_loss.png "Training loss for the dynamics")
    
2. We use Model Predictive Control (MPC) to design expert stabilizing trajectories.
    ![A trajectory generated by MPC](Expert_MPC_traj.png "An expert MPC trajectory")
    ![Anothr trajectory generated by MPC](Expert_MPC_traj2.png "Another expert MPC trajectory")
